...
# table_rows = soup.select("#tbl2 tr.portID")

# for table_row in table_rows:
#     cells = table_row.findAll('td')
#     print(len(cells))
#     port_id = cells[0].get_text()
#     inputs = table_row.findAll('input')
#     for input in inputs:
#         print(input.attrs)
        ...
        # if input['name'] == 'rxPkt':
        #     # convert to decimal
        #     nbytes_rx = int(input['value'].strip(), 16)
        #     print(port_id
        #     )
        #     print(input['value'])
        #     # live_settings[port_id] = {'BytesReceived': input['value'].strip()}
        # # elif input['name'] == 'txpkt':
        # #     nbytes_tx = int(input['value'].strip(), 16)
    ...
    # for cell in cells:
    #     inputs = cell.findAll(attrs={"name": "rxPkt"}

   # elif input['name'] == 'crcPkt':
#     ncrcbytes = int(input['value'].strip(), 16)
